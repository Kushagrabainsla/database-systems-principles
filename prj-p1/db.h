...
typedef enum error_return_codes
{
  ...
  /* Must add all the possible errors from I/U/D + SELECT here */
	...
	FILE_WRITE_ERROR = -298,			// -298
	DBFILE_CORRUPTION = -297,			// -297
	MEMORY_ERROR = -296,				// -296
	TYPE_MISMATCH = -295,          // -295
	INVALID_INSERT_DEFINITION = -294,// -294
	NOT_NULL_CONSTRAINT_VIOLATION = -293 // -293
} return_codes;
